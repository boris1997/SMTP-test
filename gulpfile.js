...
function css(html, style) {
    return src(path.src.css)
        ...
        .pipe(purgecss({
            content: [`public/${html}`],
            safelist: ['page__sidebar--active', 'body--noscroll', 'sidebar__content--active', 'overlay--show', 'hamburger-menu__content--active', 'direction__accordion-body--hide', 'page_screen_full', 'incDec-btn--minus']
        }))
